...
public class VoxelWeaponLookup {
    ...
    public static final BuilderCodec<VoxelWeaponLookup> CODEC = BuilderCodec.builder(VoxelWeaponLookup.class, VoxelWeaponLookup::new)
            .append(
