...
public class RouterSignatureInteraction extends RunRootInteraction {
    public static final BuilderCodec<RouterSignatureInteraction> CODEC = BuilderCodec.builder(
            RouterSignatureInteraction.class, RouterSignatureInteraction::new, RunRootInteraction.CODEC
    ).build();
