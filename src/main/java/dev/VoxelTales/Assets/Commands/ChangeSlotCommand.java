...
public class ChangeSlotCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        player.getInventory().getHotbar().setItemStackForSlot(newSlot, VoxelSwordHelper.generateItemStack(weaponHandlerComponent));

        VoxelInventoryHelper.syncHotbar(playerRef, ref, store);
